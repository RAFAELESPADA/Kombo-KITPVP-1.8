...
public class Report implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command arg1, String arg2, String[] args) {
       ...
       Player targetPlayer;
        ...
        if (WaveCooldown.inCooldown(sender.getName(), "report")) {
            sender.sendMessage("§cEspere " + WaveCooldown.getTime(sender.getName(), "report") + " segundos para reportar novamente.");
            return true;
        }
        ...
        WaveCooldown.create(sender.getName(), "report", TimeUnit.SECONDS, 60L);
