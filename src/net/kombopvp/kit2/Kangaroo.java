...
public class Kangaroo extends KitHandler2 {
	...
	public void execute(Player player) {
		...
		else if (p.getLocation().getY() > KomboPvP.getInstance().getConfig().getInt("SpawnAltura") && EnderMageReal.isSpawn(p.getLocation())) {
		...
		/*  61 */       if (GladiatorListener2.combateGlad.containsKey(p)) {
		/*  62 */         p.sendMessage(String.valueOf("§7Você está no gladiator e ganhou um efeito de speed!"));
		/*     */         
