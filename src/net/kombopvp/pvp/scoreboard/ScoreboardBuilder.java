...
public class ScoreboardBuilder {
	...
	public ScoreboardBuilder(KomboPvP plugin) {
...
public static void init() {
    ...
    text5 = "LAVA";
    text4 = "DUELOS";
    Bukkit.getScheduler().runTaskTimer(KomboPvP.getInstance(), new Runnable() {
          public void run() {
	...
	public void build(Player player) {
		 {
			 ...
			 if (WaveWarp2.SPAWN.hasPlayer(player.getName()) && !GladiatorListener2.combateGlad.containsKey(player)) {
				 player.getScoreboard().clearSlot(DisplaySlot.SIDEBAR);
					...
					String lx = " §fXP: §a";
					String l2 = "§0";
					String l1 = KomboPvP.getInstance().getConfig().getString("IPScore").replace("&", "§");
			 ...
			 Scoreboard scoreboard2 = Bukkit.getScoreboardManager().getNewScoreboard();
				...
				update(player);
				 ...
				 Scoreboard scoreboard2 = Bukkit.getScoreboardManager().getNewScoreboard();
					...
					String l1 = "§0";
					String l0 = KomboPvP.getInstance().getConfig().getString("IPScore").replace("&", "§"); 
					objective2.getScore(l8).setScore(8);
